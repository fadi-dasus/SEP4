...
//		Iterable<Temperature> list = service.findAllTemperature(room_id);
//		Temperature temperature = new Temperature();
//		temperature.add(linkTo(methodOn(TemperatureController.class).findAllTemperature(room_id)).withSelfRel());
